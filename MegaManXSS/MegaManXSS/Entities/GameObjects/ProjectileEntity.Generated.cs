...
{
	public partial class ProjectileEntity : PositionedObject, IDestroyable
	{
        ...
        public ProjectileEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public ProjectileEntity(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("ProjectileEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class ProjectileEntityExtensionMethods
	{
	}
