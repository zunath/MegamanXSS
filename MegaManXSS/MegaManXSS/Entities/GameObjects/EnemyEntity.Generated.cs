...
{
	public partial class EnemyEntity : PositionedObject, IDestroyable
	{
        ...
        public EnemyEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public EnemyEntity(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("EnemyEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class EnemyEntityExtensionMethods
	{
	}
