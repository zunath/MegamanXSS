...
namespace MegaManXSS.Entities.Testing
{
	public partial class PlatformerCharacterBase : PositionedObject, IDestroyable
	{
		...
		private static Dictionary<string, MovementValues> MovementValues;
		
		private FlatRedBall.Math.Geometry.AxisAlignedRectangle Collision;
		public MegaManXSS.DataTypes.MovementValues GroundMovement = MovementValues["ImmediateVelocityOnGround"];
		public MegaManXSS.DataTypes.MovementValues AirMovement = MovementValues["ImmediateVelocityBeforeDoubleJump"];
		public MegaManXSS.DataTypes.MovementValues AfterDoubleJump = MovementValues["ImmediateVelocityInAir"];
...
// Generated AddToManagers
		...
		public virtual void PostInitialize ()
		{
			...
			if (Collision!= null && Collision.Parent == null)
			{
			...
			GroundMovement = MovementValues["ImmediateVelocityOnGround"];
			AirMovement = MovementValues["ImmediateVelocityBeforeDoubleJump"];
			AfterDoubleJump = MovementValues["ImmediateVelocityInAir"];
		...
		public virtual void AddToManagersBottomUp (Layer layerToAddTo)
		{
			...
			RotationY = 0;
			RotationZ = 0;
			ShapeManager.AddToLayer(Collision, layerToAddTo);
			Collision.ScaleX = 16f;
			Collision.ScaleY = 24f;
			X = oldX;
			Y = oldY;
	...
	// Extra classes
	public static class PlatformerCharacterBaseExtensionMethods
	{
	}
