...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			{
				DebugWindowObject.Detach(); TextManager.RemoveText(DebugWindowObject);
			}
		...
		public virtual void PostInitialize ()
		{
			...
			if (DebugWindowObject!= null && DebugWindowObject.Parent == null)
			{
		...
		public virtual void AddToManagersBottomUp (Layer layerToAddTo)
		{
			...
			RotationY = 0;
			RotationZ = 0;
			TextManager.AddToLayer(DebugWindowObject, layerToAddTo);
			DebugWindowObject.SetPixelPerfectScale(layerToAddTo);
			if (DebugWindowObject.Parent == null)
			{
				DebugWindowObject.X = 50f;
			}
		...
		public virtual void SetToIgnorePausing ()
		{
			...
			InstructionManager.IgnorePausingFor(DebugWindowObject);
		}
	...
	// Extra classes
	public static class DebugWindowEntityExtensionMethods
	{
	}
