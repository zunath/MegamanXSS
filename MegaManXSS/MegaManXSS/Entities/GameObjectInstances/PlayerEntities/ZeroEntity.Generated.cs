...
{
	public partial class ZeroEntity : MegaManXSS.Entities.GameObjects.PlayerEntity, IDestroyable
	{
        ...
        public ZeroEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public ZeroEntity(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("ZeroEntityStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class ZeroEntityExtensionMethods
	{
	}
