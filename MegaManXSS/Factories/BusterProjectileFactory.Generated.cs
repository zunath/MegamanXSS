...
{
	public class BusterProjectileFactory : IEntityFactory
	{
		...
		public static void MakeUnused (BusterProjectile objectToMakeUnused, bool callDestroy)
		{
			...
			{
				return BusterProjectileFactory.CreateNew();
			}
			object IEntityFactory.CreateNew (Layer layer)
			{
				return BusterProjectileFactory.CreateNew(layer);
			}
			public static PositionedObjectList<BusterProjectile> ScreenListReference
			{
				get
				{
			...
			static BusterProjectileFactory mSelf;
			public static BusterProjectileFactory Self
			{
				get
				{
					if (mSelf == null)
					{
						mSelf = new BusterProjectileFactory();
					}
					return mSelf;
				}
			}
